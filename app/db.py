...
def init_db():
    from app.models import customer, employee, integrations, report, user, billing, medical_exam, epi_purchase, exam_catalog, benefit_event, product_catalog, training_catalog, training_record, cc_item_price, billing_model, audit_log, codcal_classification, ai_chat_session
